...
5. If you see spaces at the end or beginning, these are intentional e.g. ' from your settings. '
...
const LANG_SHIP_SIZE = 'size';
const LANG_SHIP_DAMAGE = 'damage';
const LANG_SHIP_DAMAGE_R = 'rate of fire';
const LANG_SHIP_DAMAGE_K = 'armor piercing';
const LANG_SHIP_DAMAGE_M = 'explosive';
const LANG_SHIP_DAMAGE_E = 'shield bypass';
const LANG_SHIP_ARMOR = 'armor';
const LANG_SHIP_SHIELD = 'shield';
const LANG_SHIP_EVASION = 'evasion';
const LANG_SHIP_COST = 'cost';
/*
* END Ships
*/
...
const SHORT_THOUSAND = 'TH';
const SHORT_MILLION = 'M';
const SHORT_BILLION = 'B';
const SHORT_TRILLION = 'T';
const SHORT_QUADRILLION = 'QU';
const SHORT_QUINTILLION = 'QI';
...
$lang['INDEX_BETA_TEXT'] = 'This is not the live game. It is regularly reset and your actions will not have a lasting impact your settings.';
...
$lang['FORGOT_EMAIL'] = 'Provide the email address of your settings. We will send you a link to reset your password.';
...
$lang['FORGOT_ACTIVATE2'] = 'Please follow the link below to active your settings:';
...
$lang['FORGOT_SPAM'] = 'A link to reset your settings password has been sent to your email address, make sure to check your spam folder';
...
$lang['TOS_CHEATS'] = 'Cheaters will be banned, suspended, or get their settings modified at any time once caught  without warning. Rules are located in the ';
...
//$lang['ACTIVATE_P_BP'] = 'When you pick your Race, you are only picking the names for your settings. Your choice has no influence on your settings skills within the game. After you login you will be able to choose what areas you want your	bonus to be in.';
...
$lang['REGISTER_EMAIL_LINK'] = 'Please follow the link below to active your settings:';
...
$lang['REGISTER_WARNING2'] = 'In the interest of fairness, there is a limit of one settings per player. Players caught with multiple accounts will be removed from the game.';
...
const MENU_UNIVERSE = 'Universe - %s attack turns available';
...
$lang['UNIVERSE_TOP_PLAYER'] = 'Top Players!';
...
$lang['UNITS'] = 'Units';
$lang['UNCOVERED_UNITS'] = 'Uncovered units';
$lang['UNCOVERED_OPERATION_CELL'] = 'Cell #';
$lang['OPERATION_CELLS'] = 'Discovered Operation Cells';
$lang['OPERATION_CELLS_DESC'] = 'Discovered by your defending spies, operation cells represent a fraction of the larger operations deployed against you.<br><br>These cells can be investigated and destroyed to ensure the security of your empire.';
$lang['OPERATION_EXPELLED'] = 'You have purged this cell from your empire.';
$lang['OPERATION_INVESTIGATED'] = 'Your spies have completed their investigation.';
$lang['CELLS_NONE'] = "Your spies have not uncovered any operation cells within your empire.<br><br>Detection occurs automatically, train additional spies to increase their chance of success.";
$lang['FREE'] = 'Free';
...
$lang['OPERATIONS_EXPEL_DESC'] = "Instantly remove this cell and it's discovered agents from your empire.<br><br>This will result in a loss of intel points for the operation, but the spies will safely return home.";
$lang['OPERATIONS_INVESTIGATE_DESC'] = 'Investigate a cell to uncover additional units and reveal the player responsible.<br><br>Larger cells are more easily detected, and training additional spies will improve your success.';
$lang['OPERATIONS_INVESTIGATE_COST_DESC_1'] = 'Investigating an operation cell costsa base rate of ';
$lang['OPERATIONS_INVESTIGATE_COST_DESC_2'] = ' per trained spy in your empire.<br><br>Each cell will have an additional cost based on the number of discovered units.';
$lang['OPERATIONS_INVESTIGATE_COST'] = 'Investigation Cost: ';
$lang['INVESTIGATE'] = 'Investigate';
$lang['EXPEL'] = 'Expel';
$lang['SPIES_DISCOVERED'] = 'Your spies report the following:';
...
$lang['RECALL'] = 'Recall';
$lang['DEPLOY'] = 'Deploy';
$lang['SPIES_RECALL'] = 'Spies to recall';
$lang['SPIES_DEPLOY'] = 'Spies to deploy';
...
$lang['MVBUY_ENJOY'] = 'If you enjoy this game and would like to support this site, you may purchase MV Point packages using Paypal <em>(you do not need a Paypal settings to use credit cards)</em>';
...
$lang['MVBUY_REFUND'] = '<strong>Please note</strong>: If at some point within the specified time-frame outlined in our <a href="/main.php?tos" target="_blank"><strong>Terms of Service</strong></a> you request a refund of the payment, we reserve the right to remove any and all benefits you obtained through the (now unpaid for) bonus.';
$lang['MVBUY_REFUND_NO'] = 'This includes the possible removal of in-game upgrades, research, military, population, etc. We also reserve the right to delete the settings if a player\'s actions have are considered an intentional abuse of our system, in which case a refund will not be possible';
...
$lang['MVUSE_FREEPOINTS_TOOLTIP'] = 'These are the same as purchased points, but they are free. They can not be traded and the only way to earn them is to log in to the game at least once a day. The game will give every settings 1 point per day. When upgrading from the items below, the game will take the points from this stash first!';
...
$lang['MVUSE_BASE_DESC'] = 'Adds 1 base point to your settings, which you can place in any of the following: income, attack, defense, or covert.';
...
$lang['ACC_FB_YOU'] = 'You: ';
$lang['ACC_FB_CONNECT'] = 'Link your Facebook settings:';
...
$lang['ACC_EM_UNABLE'] = 'If this e-mailbox does not go through, you will be UNABLE to access your settings';
...
$lang['ERROR_LOGIN_VACA'] = 'Your settings is still on vacation for at least another ';
$lang['ERROR_LOGIN_HOURS'] = ' hours';
$lang['ERROR_LOGIN_BANNED'] = 'Your settings has been banned';
$lang['ERROR_LOGIN_MISC'] = 'Your settings has an error, contact the Admin.';
...
$lang['ACCOUNT_PASSWORD_ZERO'] = 'Passwords you have entered do not match.';
...
$lang['ACTIVATE_NOPE'] = 'No such settings to activate';
...
$lang['RESEARCHATTACK1'] = 'Beam Weapons';
$lang['RESEARCHATTACK2'] = 'Kinetic Weapons';
$lang['RESEARCHATTACK3'] = 'Missile Weapons';

$lang['RESEARCHSHIELD1'] = 'Shields';
$lang['RESEARCHSHIELD2'] = 'Armour';
$lang['RESEARCHSHIELD3'] = 'Point Defense';

$lang['RESEARCHHULL1'] = 'Hull';
$lang['RESEARCHHULL2'] = 'Mobility';
$lang['RESEARCHHULL3'] = 'Targeting';
...
$lang['RESEARCHATTACK3_DESC'] = 'Increase the strength of your missile weapons.';

$lang['RESEARCHSHIELD1_DESC'] = 'Increase the strength of your shields.';
$lang['RESEARCHSHIELD2_DESC'] = 'Increase the strength of your armour.';
$lang['RESEARCHSHIELD3_DESC'] = 'Increase the strength of your point defense.';

$lang['RESEARCHHULL1_DESC'] = 'Increase the hull strength of your ships.';
$lang['RESEARCHHULL2_DESC'] = 'Increase the mobile of your ships.';
$lang['RESEARCHHULL3_DESC'] = 'Increase the accuracy of your ships weapons. ';
...
$lang['RELATIONS_COMMANDER_REMOVED'] = 'You have removed yourself from your commander.';
